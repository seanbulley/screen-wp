 ...
 */
class VUWU_Slide_Formats {

	/**
	 * Adds the Default slide format.
	 *
	 * @since	1.4.0	Default slide format is now also added through filter, instead of in VUWU_Slides.
	...
	static function add_default_slide_format( $slide_formats ) {
		 ...
		 */
		$slide_format_backgrounds = apply_filters( 'vuwu/slides/backgrounds/format=default', $slide_format_backgrounds );

		$slide_formats['default'] = array(
			'title' => _x( 'Default', 'slide-format', 'vuwu' ),
			'description' => __( 'Displays a background only.', 'vuwu' ),
	...
	static function add_iframe_slide_format( $slide_formats ) {
		 ...
		 * @param	array	$slide_format_backgrounds	The currently available slide backgrounds for this slide format.
		 */
		$slide_format_backgrounds = apply_filters( 'vuwu/slides/backgrounds/format=iframe', $slide_format_backgrounds );

		$slide_formats['iframe'] = array(
			'title' => _x( 'External web page', 'slide-format', 'vuwu' ),
			'description' => __( 'Displays a web page to your liking.', 'vuwu' ),
			'meta_box' => array( 'VUWU_Admin_Slide_Format_Iframe', 'slide_meta_box' ),
			'save_post' => array( 'VUWU_Admin_Slide_Format_Iframe', 'save_slide' ),
			'slide_backgrounds' => $slide_format_backgrounds,
		);
		return $slide_formats;
	}
	...
	static function add_pdf_slide_format( $slide_formats ) {
		...
		$slide_formats['pdf'] = array(
			'title' => _x( 'PDF', 'slide-format', 'vuwu' ),
			'description' => __( 'Displays a slide for each page in the uploaded PDF.', 'vuwu' ),
			'meta_box' => array( 'VUWU_Admin_Slide_Format_PDF', 'slide_pdf_meta_box' ),
			'save_post' => array( 'VUWU_Admin_Slide_Format_PDF', 'save_slide_pdf' ),
			'slide_backgrounds' => $slide_format_backgrounds,
			'stack' => true,
		);
		return $slide_formats;
	...
	static function add_post_slide_format( $slide_formats ) {
		 ...
		 * @param	array	$slide_format_backgrounds	The currently available slide backgrounds for this slide format.
		 */
		$slide_format_backgrounds = apply_filters( 'vuwu/slides/backgrounds/format=post', $slide_format_backgrounds );

		$slide_formats['post'] = array(
			'title' => _x( 'Post', 'slide-format', 'vuwu' ),
			'description' => __( 'Displays title, date and content of a post.', 'vuwu' ),
			'meta_box' => array( 'VUWU_Admin_Slide_Format_Post', 'slide_meta_box' ),
			'save_post' => array( 'VUWU_Admin_Slide_Format_Post', 'save_slide' ),
			'slide_backgrounds' => $slide_format_backgrounds,
		);
		return $slide_formats;
	}
	 ...
	 *
	 * @since	1.0.0
	 * @since	1.1.0	Moved here from VUWU_Theater, and changed to static.
	...
	static function add_production_slide_format( $slide_formats ) {
		...
		if ( ! VUWU_Theater::is_theater_activated() ) {
			return $slide_formats;
		}
		 ...
		 * @param	array	$slide_format_backgrounds	The currently available slide backgrounds for this slide format.
		 */
		$slide_format_backgrounds = apply_filters( 'vuwu/slides/backgrounds/format=production', $slide_format_backgrounds );

		$slide_formats['production'] = array(
			'title' => _x( 'Event', 'slide-format', 'vuwu' ),
			'description' => __( 'Displays title and details of an event, with its image as default background.', 'vuwu' ),
			'meta_box' => array( 'VUWU_Admin_Slide_Format_Production', 'slide_production_meta_box' ),
			'save_post' => array( 'VUWU_Admin_Slide_Format_Production', 'save_slide_production' ),
			'slide_backgrounds' => $slide_format_backgrounds,
	...
	static function add_recent_posts_slide_format( $slide_formats ) {
		 ...
		 * @param	array	$slide_format_backgrounds	The currently available slide backgrounds for this slide format.
		 */
		$slide_format_backgrounds = apply_filters( 'vuwu/slides/backgrounds/format=recent-posts', $slide_format_backgrounds );

		$slide_formats['recent-posts'] = array(
			'title' => 'Recent posts',
			'description' => 'Displays a slide for each recent post.',
			'meta_box' => array( 'VUWU_Admin_Slide_Format_Recent_Posts', 'slide_meta_box'),
			'save_post' => array( 'VUWU_Admin_Slide_Format_Recent_Posts', 'save_slide'),
			'slide_backgrounds' => $slide_format_backgrounds,
			'stack' => true,
		);
	...
	static function add_text_slide_format( $slide_formats ) {
		 ...
		 * @param	array	$slide_format_backgrounds	The currently available slide backgrounds for this slide format.
		 */
		$slide_format_backgrounds = apply_filters( 'vuwu/slides/backgrounds/format=text', $slide_format_backgrounds );

		$slide_formats['text'] = array(
			'title' => _x( 'Text', 'slide-format', 'vuwu' ),
			'description' => __( 'Displays some text.', 'vuwu' ),
			'meta_box' => array( 'VUWU_Admin_Slide_Format_Text', 'slide_meta_box' ),
			'save_post' => array( 'VUWU_Admin_Slide_Format_Text', 'save_slide' ),
			'slide_backgrounds' => $slide_format_backgrounds,
		);
		return $slide_formats;
	}
	...
	static function add_upcoming_productions_slide_format( $slide_formats ) {
		 ...
		 * @param	array	$slide_format_backgrounds	The currently available slide backgrounds for this slide format.
		 */
		$slide_format_backgrounds = apply_filters( 'vuwu/slides/backgrounds/format=upcoming-productions', $slide_format_backgrounds );

		$slide_formats['upcoming-productions'] = array(
			'title' => 'Upcoming events',
			'description' => 'Displays a slide for each upcoming event.',
			'meta_box' => array( 'VUWU_Admin_Slide_Format_Upcoming_Productions', 'slide_meta_box'),
			'save_post' => array( 'VUWU_Admin_Slide_Format_Upcoming_Productions', 'save_slide'),
			'slide_backgrounds' => $slide_format_backgrounds,
			'default_background_template' => true,
			'stack' => true,
		);
