 ...
 */
class ScreenWP_Slide_Backgrounds {
	...
	static function add_default_slide_background( $slide_backgrounds ) {
		...
		$slide_backgrounds['default'] = array(
			'title' => _x( 'Default / none', 'slide-background', 'screenwp' ),
			'description' => __( 'Displays the default background for the chosen slide format, if any, or no background.', 'screenwp' ),
		);
	...
	static function add_html5_video_slide_background( $slide_backgrounds ) {
		...
		$slide_backgrounds['html5-video'] = array(
			'title' => _x( 'Video', 'slide-background', 'screenwp' ),
			'meta_box' => array( 'ScreenWP_Admin_Slide_Background_Html5_Video', 'slide_background_meta_box' ),
			'save_post' => array( 'ScreenWP_Admin_Slide_Background_Html5_Video', 'save_slide_background' ),
		);
		return $slide_backgrounds;
	}
	...
	static function add_image_slide_background( $slide_backgrounds ) {
		...
		$slide_backgrounds['image'] = array(
			'title' => _x( 'Image', 'slide-background', 'screenwp' ),
			'meta_box' => array( 'ScreenWP_Admin_Slide_Background_Image', 'slide_background_meta_box' ),
			'save_post' => array( 'ScreenWP_Admin_Slide_Background_Image', 'save_slide_background' ),
		);
		return $slide_backgrounds;
	}
	...
	static function add_video_slide_background( $slide_backgrounds ) {
		...
		$slide_backgrounds['video'] = array(
			'title' => _x( 'YouTube', 'slide-background', 'screenwp' ),
			'meta_box' => array( 'ScreenWP_Admin_Slide_Background_Video', 'slide_background_meta_box' ),
			'save_post' => array( 'ScreenWP_Admin_Slide_Background_Video', 'save_slide_background' ),
		);
		return $slide_backgrounds;
	}
}
