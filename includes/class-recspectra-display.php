 ...
 */
class Recspectra_Display {

	/**
	 * The Recspectra Display post type name.
	 *
	 * @since    1.0.0
	 * @access   private
	 * @var      string    $post_type_name    The Recspectra Display post type name.
	 */
	const post_type_name = 'recspectra_display';
	...
	public function add_reset_request() {
		update_post_meta( $this->ID, 'recspectra_reset_display', 1 );
	}
	...
	public function delete_reset_request() {
		delete_post_meta( $this->ID, 'recspectra_reset_display' );
	}
	 ...
	 *
	 * @access	public
	 * @return	Recspectra_Channel	The default channel for this display.
	 */
	public function get_default_channel() {

		if ( ! isset( $this->default_channel ) ) {

			$default_channel = get_post_meta( $this->ID, Recspectra_Channel::post_type_name, true );
	...
	private function is_reset_requested() {
		return (bool) get_post_meta( $this->ID, 'recspectra_reset_display', true );
	}
}
