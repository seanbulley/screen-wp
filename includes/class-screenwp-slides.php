...
class ScreenWP_Slides {
	...
	static function get_default_slides_duration() {
		 ...
		 */
		$default_slides_duration = apply_filters( 'screenwp/slides/duration/default', $default_slides_duration );
	...
	static function get_default_slides_transition() {
		 ...
		 */
		$default_slides_transition = apply_filters( 'screenwp/slides/transition/default', $default_slides_transition );
	 ...
	 *
	 * Only returns slide format backgrounds that are registered according to ScreenWP_Slides::get_slide_backgrounds().
	 *
	 * @since	1.4.0
	...
	static function get_slide_backgrounds() {
		 ...
		 *
		 * @see ScreenWP_Slide_Backgrounds::add_image_slide_background() for an example.
		 *
		 * @since	1.4.0
		 * @param	array	$slide_backgrounds	The currently available slide backgrounds.
		 */
		$slide_backgrounds = apply_filters( 'screenwp/slides/backgrounds', $slide_backgrounds );
	...
	static function get_slide_formats() {
		 ...
		 *
		 * @see ScreenWP_Slide_Formats::add_production_slide_format() for an example.
		 *
		 * @since	1.0.0
		 * @param	array	$slide_formats	The currently available slide formats.
		 */
		$slide_formats = apply_filters( 'screenwp/slides/formats', $slide_formats );
