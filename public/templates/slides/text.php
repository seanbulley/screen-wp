	...
	<div class="inner">
		<div class="screenwp-slide-fields">
			<?php if ( ! empty( $slide_text_pretitle ) ) { ?>
				<div class="screenwp-slide-field screenwp-slide-field-pretitle"><span><?php echo $slide_text_pretitle; ?></span></div>
			<?php } ?>
			<?php if ( ! empty( $slide_text_title ) ) { ?>
				<div class="screenwp-slide-field screenwp-slide-field-title"><span><?php echo $slide_text_title; ?></span></div>
			<?php } ?>
			<?php if ( ! empty( $slide_text_subtitle ) ) { ?>
				<div class="screenwp-slide-field screenwp-slide-field-subtitle"><span><?php echo $slide_text_subtitle; ?></span></div>
			<?php } ?>
			<?php if ( ! empty( $slide_text_content ) ) { ?>
				<div class="screenwp-slide-field screenwp-slide-field-content"><?php echo wpautop( $slide_text_content ); ?></div>
			<?php } ?>
		</div>
	</div>
