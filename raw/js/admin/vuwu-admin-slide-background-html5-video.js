...
jQuery( function() {
	...
	if (jQuery('#slide_bg_html5_video_video_url').val() && jQuery('#slide_bg_html5_video_video_url').val().length) {
		...
		vuwu_admin_slide_bg_html5_video_update_url_status();
		vuwu_admin_slide_bg_html5_video_update_youtube_video_preview();
	}
	...
	jQuery('#slide_bg_html5_video_enable_sound').on('change', function() {
		...
		vuwu_admin_slide_bg_html5_video_update_player_mute();
	});
 ...
 * @since	1.6.0
 */
function vuwu_admin_slide_bg_html5_video_update_player_mute() {
...
function vuwu_admin_slide_bg_html5_video_update_url_status() {
 ...
 * @since	1.6.0
 */
function vuwu_admin_slide_bg_html5_video_update_youtube_video_preview() {
	if (jQuery('#slide_bg_html5_video_video_url').val() && jQuery('#slide_bg_html5_video_video_url').val().length) {
