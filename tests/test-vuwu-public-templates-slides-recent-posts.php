<?php
class Test_VUWU_Public_Templates_Slides_Recent_Posts extends VUWU_UnitTestCase {
	...
	function test_are_all_text_slide_field_elements_included_in_slide() {
		...
		$this->assertContains( '<div class="vuwu-slide-field vuwu-slide-field-date', $actual );
