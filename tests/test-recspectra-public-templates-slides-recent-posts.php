<?php
class Test_Recspectra_Public_Templates_Slides_Recent_Posts extends Recspectra_UnitTestCase {
	...
	function test_are_all_text_slide_field_elements_included_in_slide() {
		...
		$this->assertContains( '<div class="recspectra-slide-field recspectra-slide-field-date', $actual );
