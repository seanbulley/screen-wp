...
class Test_VUWU_Slides extends VUWU_UnitTestCase {
	...
	function test_get_slide_formats() {
		$actual = VUWU_Slides::get_slide_formats();
	...
	function test_get_slide_backgrounds() {
		$actual = VUWU_Slides::get_slide_backgrounds();
		$this->assertNotEmpty( $actual );
	}
	...
	function test_get_slide_format_backgrounds_by_slug() {
		$actual = VUWU_Slides::get_slide_format_backgrounds_by_slug( 'default' );
		$this->assertNotEmpty( $actual );
	}
	...
	function test_get_slide_format_backgrounds_by_slug_does_not_return_not_registered_backgrounds() {
		...
		add_filter( 'vuwu/slides/backgrounds/format=default', array( $this, 'add_not_registered_background_to_default_format' ) );
