...
class Test_Recspectra_Slide_Formats extends Recspectra_UnitTestCase {
	...
	function test_is_pdf_slide_format_registered() {
		$slide_format = Recspectra_Slides::get_slide_format_by_slug( 'pdf' );
	...
	function test_is_production_slide_format_not_registered() {
		...
		$slide_format = Recspectra_Slides::get_slide_format_by_slug( 'production' );
	...
	function test_is_deprecated_video_slide_format_not_registered() {
		$slide_format = Recspectra_Slides::get_slide_format_by_slug( 'video' );
		$this->assertEmpty( $slide_format );
	}

	function test_is_iframe_slide_format_registered() {
		$slide_format = Recspectra_Slides::get_slide_format_by_slug( 'iframe' );
		$this->assertNotEmpty( $slide_format );
	}

	function test_is_default_slide_format_registered() {
		$slide_format = Recspectra_Slides::get_slide_format_by_slug( 'default' );
		$this->assertNotEmpty( $slide_format );
	}
	...
	function test_are_backgrounds_for_default_slide_format_filtered() {
		add_filter( 'recspectra/slides/backgrounds/format=default', array( $this, 'replace_format_backgrounds' ) );
		...
		remove_filter( 'recspectra/slides/backgrounds/format=default', array( $this, 'remove_default_background_from_format_backgrounds' ) );
	}
	...
	function test_is_post_slide_format_registered() {
		$slide_format = Recspectra_Slides::get_slide_format_by_slug( 'post' );
		$this->assertNotEmpty( $slide_format );
	}
	...
	function test_is_text_slide_format_registered() {
		$slide_format = Recspectra_Slides::get_slide_format_by_slug( 'text' );
		$this->assertNotEmpty( $slide_format );
	}
	...
	function test_is_upcoming_productions_slide_format_not_registered() {
		// Theater plugin is not loaded by default
		$slide_format = Recspectra_Slides::get_slide_format_by_slug( 'upcoming-productions' );
		$this->assertEmpty( $slide_format );
	}
	...
	function test_is_recent_posts_slide_format_registered() {
		$slide_format = Recspectra_Slides::get_slide_format_by_slug( 'recent-posts' );
		$this->assertNotEmpty( $slide_format );
	}
}
 ...
 */
class Test_Recspectra_Slide_Formats_Theater extends Recspectra_Theater_UnitTestCase {
