<?php
class Test_Recspectra_Public_Templates_Slides_Text extends Recspectra_UnitTestCase {
	...
	function test_are_all_text_slide_field_elements_included_in_slide() {
		...
		$this->assertContains( '<div class="recspectra-slide-field recspectra-slide-field-pretitle', $actual );
		$this->assertContains( '<div class="recspectra-slide-field recspectra-slide-field-title', $actual );
		$this->assertContains( '<div class="recspectra-slide-field recspectra-slide-field-subtitle', $actual );
		$this->assertContains( '<div class="recspectra-slide-field recspectra-slide-field-content', $actual );
	}
	...
	function test_is_pretitle_element_not_included_in_text_slide_when_empty() {
		...
		$this->assertNotContains( '<div class="recspectra-slide-field recspectra-slide-field-pretitle', $actual );
	}
	...
	function test_is_title_element_not_included_in_text_slide_when_empty() {
		...
		$this->assertNotContains( '<div class="recspectra-slide-field recspectra-slide-field-title', $actual );
	}
	...
	function test_is_subtitle_element_not_included_in_text_slide_when_empty() {
		...
		$this->assertNotContains( '<div class="recspectra-slide-field recspectra-slide-field-subtitle', $actual );
	}
	...
	function test_is_content_element_not_included_in_text_slide_when_empty() {
		...
		$this->assertNotContains( '<div class="recspectra-slide-field recspectra-slide-field-content', $actual );
	}
}
