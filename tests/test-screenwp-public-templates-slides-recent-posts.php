<?php
class Test_ScreenWP_Public_Templates_Slides_Recent_Posts extends ScreenWP_UnitTestCase {
	...
	function test_are_all_text_slide_field_elements_included_in_slide() {
		...
		$this->assertContains( '<div class="screenwp-slide-field screenwp-slide-field-date', $actual );
