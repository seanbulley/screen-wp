...
class Test_ScreenWP_Public_Templates_Slides_Backgrounds_Video extends ScreenWP_UnitTestCase {
	...
	function test_are_all_slide_background_video_properties_included_in_slide() {
		...
		$expected = 'data-screenwp-video-id="' . $video_id . '"';
		$this->assertContains( $expected, $actual );

		$expected = 'data-screenwp-video-start="' . $video_start . '"';
		$this->assertContains( $expected, $actual );

		$expected = 'data-screenwp-video-end="' . $video_end . '"';
		$this->assertContains( $expected, $actual );

		$expected = 'data-screenwp-hold-slide="' . $hold_slide . '"';
		$this->assertContains( $expected, $actual );

		$expected = 'data-screenwp-output-sound="' . $enable_sound . '"';
		$this->assertContains( $expected, $actual );
	}
}
