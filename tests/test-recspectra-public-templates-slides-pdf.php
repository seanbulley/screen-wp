...
class Test_Recspectra_Public_Templates_Slides_PDF extends Recspectra_UnitTestCase {
	...
	function test_are_all_pdf_pages_included_in_slide() {
		...
		Recspectra_Admin_Slide_Format_PDF::add_pdf_images_to_attachment( $pdf_attachment_id );
