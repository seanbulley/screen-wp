 ...
 */
class VUWU_Admin_Slide_Background_Html5_Video {
	...
	static function slide_background_meta_box( $post ) {
		...
		?><table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label for="slide_bg_html5_video_video_url"><?php _e( 'Video file', 'vuwu' ); ?></label>
					</th>
					<td>
						<div class="slide_file_field file_type_video<?php if ( empty( $slide_bg_image_image ) ) { ?> empty<?php } ?>" id="slide_bg_html5_video_file_field">
							...
							<p class="wp-ui-text-notification hidden" id="slide_bg_html5_video_video_url_notification">
								<?php printf( esc_html__( 'Unable to play video. Please check if the URL is valid, eg. %s', 'vuwu' ), 'https://archive.org/24/items/WildlifeSampleVideo/Wildlife.mp4' ); ?>
							</p>

							<input type="button" class="button slide_file_upload_button" value="<?php esc_html_e( 'Select video', 'vuwu' ); ?>" />
							<input type="button" class="button slide_file_delete_button" value="<?php esc_html_e( 'Remove video', 'vuwu' ); ?>" />
							...
							<p class="slide_file_empty_message"><?php _e( 'Select a video or manually enter a video URL.', 'vuwu' ); ?> <?php _e( 'For the best results use an MP4 video that is at least 1920 x 1080 pixels (landscape), or 1080 x 1920 pixels (portrait).', 'vuwu' ); ?></p>
						</div>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="slide_bg_html5_video_video_start"><?php _e('Start at', 'vuwu'); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_bg_html5_video_video_end"><?php _e('End at', 'vuwu'); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_bg_html5_video_hold_slide"><?php _e('Hold slide until end?', 'vuwu'); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_bg_html5_video_enable_sound"><?php _e('Enable sound?', 'vuwu'); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_bg_html5_video_video_preview"><?php _e('Preview', 'vuwu'); ?></label>
					</th>
					<td>
