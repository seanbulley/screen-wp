 ...
 */
class ScreenWP_Admin_Slide_Format_Iframe {
	...
	static function slide_meta_box( $post ) {
		...
		$placeholder = __( 'https://...', 'screenwp' );

		?><table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label for="slide_iframe_website_url"><?php _e( 'Web page URL', 'screenwp' ); ?></label>
					</th>
					<td>
						...
						<?php if ( $https ) { ?>
							<p><?php _e( 'Be sure to use an https URL', 'screenwp' ); ?></p>
						<?php } ?>
					</td>
				</tr>
			</tbody>
