 ...
 */
class Recspectra_Admin_Slide_Format_Text {
	...
	static function slide_meta_box( $post ) {
		...
		?><table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label for="slide_text_pretitle"><?php _e( 'Pre-title', 'recspectra' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_text_title"><?php _e( 'Title', 'recspectra' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_text_subtitle"><?php _e( 'Subtitle', 'recspectra' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_text_content"><?php _e( 'Content', 'recspectra' ); ?></label>
					</th>
					<td>
