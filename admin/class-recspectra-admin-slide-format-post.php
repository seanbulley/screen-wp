 ...
 */
class Recspectra_Admin_Slide_Format_Post {
	...
	static function slide_meta_box( $post ) {
		...
		?><table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label for="slide_post_post_id"><?php _ex( 'Post', 'slide-format', 'recspectra' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_post_display_thumbnail"><?php _e( 'Display featured image?', 'recspectra' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_post_use_excerpt"><?php _e( 'Use excerpt?', 'recspectra' ); ?></label>
					</th>
					<td>
