 ...
 */
class VUWU_Admin_Slide_Format_Upcoming_Productions {
	...
	static function slide_meta_box( $post ) {
		...
		?><table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label for="slide_upcoming_productions_limit"><?php _e( 'Display a maximum of', 'vuwu' ); ?></label>
					</th>
					<td>
						<input type="number" min="0" step="1" id="slide_upcoming_productions_limit" name="slide_upcoming_productions_limit" class="small-text" value="<?php echo $slide_upcoming_productions_limit; ?>" /> <?php _e( 'events', 'vuwu' ); ?>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="slide_upcoming_productions_categories[]"><?php _e( 'Only display events from categories', 'vuwu' ); ?></label>
					</th>
					<td>
