 ...
 *
 * Functionality was copied from Recspectra_Admin_Slide_Format_Video (removed in 1.4.0).
 *
 * @since		1.4.0
 *
 * @package		Recspectra
 ...
 */
class Recspectra_Admin_Slide_Background_Video {

	/**
	 * Saves additional data for the Video slide background.
	 *
	 * Functionality was copied from Recspectra_Admin_Slide_Format_Video (removed).
	 *
	 * @since	1.4.0
	...
	static function slide_background_meta_box( $post ) {
		...
		?><table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label for="slide_bg_video_video_url"><?php _e('YouTube video URL', 'recspectra'); ?></label>
					</th>
					<td>
						...
						<p class="wp-ui-text-notification hidden" id="slide_bg_video_video_url_notification">
							<?php printf( esc_html__( 'Not a valid YouTube video URL, eg. %s', 'recspectra' ), 'https://youtu.be/MlQunle406U' ); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="slide_bg_video_video_start"><?php _e('Start at', 'recspectra'); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_bg_video_video_end"><?php _e('End at', 'recspectra'); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_bg_video_hold_slide"><?php _e('Hold slide until end?', 'recspectra'); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_bg_video_enable_sound"><?php _e('Enable sound?', 'recspectra'); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_bg_video_video_preview"><?php _e('Preview', 'recspectra'); ?></label>
					</th>
					<td>
						<div class="youtube-video-container" id="recspectra-admin-video-preview"></div>
					</td>
				</tr>
			</tbody>
		</table><?php
