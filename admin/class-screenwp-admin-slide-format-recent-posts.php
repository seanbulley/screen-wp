 ...
 */
class ScreenWP_Admin_Slide_Format_Recent_Posts {
	...
	static function slide_meta_box( $post ) {
		...
		?><table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label for="slide_recent_posts_limit"><?php _e( 'Display a maximum of', 'screenwp' ); ?></label>
					</th>
					<td>
						<input type="number" min="0" step="1" id="slide_recent_posts_limit" name="slide_recent_posts_limit" class="small-text" value="<?php echo $slide_recent_posts_limit; ?>" /> <?php _e( 'posts', 'screenwp' ); ?>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="slide_recent_posts_categories[]"><?php _e( 'Only display posts from categories', 'screenwp' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_recent_posts_display_thumbnail"><?php _e( 'Display featured image?', 'screenwp' ); ?></label>
					</th>
					<td>
						...
						<span><?php _e( 'Yes, display the featured image.', 'screenwp' ); ?></span>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="slide_recent_posts_use_excerpt"><?php _e( 'Use excerpt?', 'screenwp' ); ?></label>
					</th>
					<td>
						...
						<span><?php _e( 'Yes, use the manual excerpt instead of the post content.', 'screenwp' ); ?></span>
					</td>
				</tr>
			</tbody>
		</table><?php
