 ...
 */
class ScreenWP_Admin_Slide_Format_Text {
	...
	static function slide_meta_box( $post ) {
		...
		?><table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label for="slide_text_pretitle"><?php _e( 'Pre-title', 'screenwp' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_text_title"><?php _e( 'Title', 'screenwp' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_text_subtitle"><?php _e( 'Subtitle', 'screenwp' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="slide_text_content"><?php _e( 'Content', 'screenwp' ); ?></label>
					</th>
					<td>
